...
CREATE TABLE ARTICLE (
  ...
  `TYPE` int(4) unsigned NOT NULL DEFAULT 10 COMMENT '文章类别，10：普通文章',
  `STATUS` int(4) NOT NULL DEFAULT 10 COMMENT '文章状态，0：草稿箱，10：已发布 20：已删除',
  ...
  `GROUP_NAME` varchar(30) NULL COMMENT '组别名称',
  ...
  `COMMENT_STATUS` int(4) NOT NULL DEFAULT 20 COMMENT '评论状态，0：评论关闭且不显示已有评论，10：可评论但不显示其他评论 20：可评论并显示所有评论',
  `COMMENT_COUNT` int(11) NOT NULL DEFAULT -1 COMMENT '文章评论数量统计',
